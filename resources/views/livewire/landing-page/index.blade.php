<div>
                    ...
                    <div class="col-xl-5">
                        <div class="banner-wrap">
                            <div class="banner" data-parallax='{"x": 0, "y": 60}'>
                                <img src="{{ asset('assets/images/custom/bg_banner.png') }}" alt="Banner">
                            </div>
                            <div class="feature">
                                <span>
    ...
    <!-- Start Course Area -->
    <div class="rbt-course-area rbt-sec-cir-shadow-1 bg-color-extra2 rbt-section-gap" id="psikotes_section">
            ...
            <div class="row mb--30">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        <h6 class="b2 mb--15">
                            <span class="theme-gradient">Psikotes</span>
                        </h6>
                ...
                <div class="col-lg-12">
                    <ul class="rbt-course-tab-button nav nav-tabs" id="rbt-myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="active" id="development-tab" data-bs-toggle="tab" data-bs-target="#development" type="button" role="tab" aria-controls="development" aria-selected="true"><span class="filter-text">Keperibadian</span></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button id="ui_ux-tab" data-bs-toggle="tab" data-bs-target="#ui-ux" type="button" role="tab" aria-controls="ui-ux" aria-selected="false"><span class="filter-text">Kinerja</span></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button id="marketing-tab" data-bs-toggle="tab" data-bs-target="#marketing" type="button" role="tab" aria-controls="marketing" aria-selected="false"><span class="filter-text">Masa Depan</span></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button id="business-tab" data-bs-toggle="tab" data-bs-target="#business" type="button" role="tab" aria-controls="business" aria-selected="false"><span class="filter-text">Kesehatan</span></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button id="language-tab" data-bs-toggle="tab" data-bs-target="#language" type="button" role="tab" aria-controls="language" aria-selected="false"><span class="filter-text">Gangguan</span></button>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        <div class="rbt-card-img">
                                            <a href="http://127.0.0.1:8001/courses/course-details">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">React Front to Back</a>
                                            </h4>
                                            ...
                                            <div class="rbt-card-bottom">
                                                ...
                                                <a class="rbt-btn-link color-primary" href="http://127.0.0.1:8001/courses/course-details">Enroll Course<i class="feather-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">English Popular Course</a>
                                            </h4>
                                            <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                            <div class="rbt-review">
                                                <div class="rating">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Data Science & ML</a>
                                            </h4>
                                            <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                            <div class="rbt-review">
                                                <div class="rating">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Graphic Design</a>
                                            </h4>
                                            <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                            <div class="rbt-review">
                                                <div class="rating">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Web Front To Back</a>
                                            </h4>
                                            <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                            <div class="rbt-review">
                                                <div class="rating">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="rbt-card variation-04 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">App Development</a>
                                            </h4>
                                            <p class="rbt-card-text">Orem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                                            <div class="rbt-review">
                                                <div class="rating">
            ...
            <div class="row mt--55">
                <div class="col-lg-12">
                    <div class="load-more-btn text-center">
                        <a class="rbt-btn btn-gradient btn-lg hover-icon-reverse" href="http://127.0.0.1:8001/courses/course-with-tab-two">
                            <span class="icon-reverse-wrapper">
    ...
    <!-- Start Blog Area -->
    <div class="rbt-rbt-blog-area rbt-section-gap bg-color-extra2 rbt-sec-cir-shadow-1" id="blog_section">
            ...
            <div class="row mb--60 g-5 align-items-end">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="load-more-btn text-start text-md-end">
                        <a class="rbt-btn btn-gradient hover-icon-reverse" href="http://127.0.0.1:8001/blog/blog">
                            <span class="icon-reverse-wrapper">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Difficult Things About Education.</a></h5>
                            <p class="rbt-card-text">There are many variations of passages of Ipsum available,</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="http://127.0.0.1:8001/courses/course-details">Read
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Learn How More Money With
                                    lms.</a></h5>
                            <p class="rbt-card-text">There are many variations of passages of Ipsum available,</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="http://127.0.0.1:8001/courses/course-details">Read
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="http://127.0.0.1:8001/courses/course-details">Understand The Background Of
                                    lms.</a></h5>
                            <p class="rbt-card-text">There are many variations of passages of Ipsum available,</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="http://127.0.0.1:8001/courses/course-details">Read
